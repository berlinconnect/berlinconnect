    ...
    <div class="cols">
      <div class="col giving-copy">
        <?= kirbytext($page->text()) ?>
          ...
          <button data-track="<?= $page->title() ?>:Give Now:Online Giving Section"  type="submit" class="giving button" border="0" name="submit" alt="Support us now by donating through PayPal.">Give Now</button>
