...
<section class="sundays">
  <div class="wrapper">
    <div class="intro center wow fadeInUp">
  ...
  <div class="slates">
    <div id="sunday" class="slate square big wow fadeIn">
    ...
    <div id="guest-speakers" class="slate rectangle wow fadeIn" data-wow-delay="0.25s">
      <div class="background-image"></div>
      <div class="caption">
    ...
    <div id="youth" class="slate square small wow fadeIn" data-wow-delay="0.5s">
      <div class="background-image"></div>
      <div class="caption">
    ...
    <div id="children" class="slate square small wow fadeIn" data-wow-delay="0.75s">
      <div class="background-image"></div>
      <div class="caption">
...
<section class="community">
  ...
  <div class="slates">
    <div id="dinner-party" class="slate rectangle big wow fadeIn">
      <div class="background-image"></div>
      <div class="caption">
    ...
    <div id="sisterhood" class="slate rectangle big wow fadeIn" data-wow-delay="0.25s">
      <div class="background-image"></div>
      <div class="caption">
...
<section class="social">
  ...
  <div class="slates">
    <div id="kindness" class="slate rectangle wow fadeIn">
      <div class="background-image"></div>
      <div class="caption">
    ...
    <div id="futureminded" class="slate rectangle wow fadeIn" data-wow-delay="0.25s">
      <div class="background-image"></div>
      <div class="caption">
